...
import { PublishType, UpcomingEvent } from './types'
...
import { DrawerCloseButton } from '@payloadcms/ui/elements/BulkUpload/DrawerCloseButton'
import { DatePickerField } from '@payloadcms/ui/elements/DatePicker'
import {  } from '@payloadcms/ui'
...
type Props = {
  ...
  slug: string
  schedulePublishUse:boolean
  setSchedulePublishUse:React.Dispatch<React.SetStateAction<boolean>>
}
...
export const ScheduleDrawer: React.FC<Props> = ({ slug, defaultType, schedulePublishConfig, schedulePublishUse, setSchedulePublishUse }) => {
  ...
  const handleSave = React.useCallback(async () => {
    ...
    setProcessing(true)
    //Put check for conflicts here
    setSchedulePublishUse(true)

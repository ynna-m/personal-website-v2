...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_blog_block_sort" AS ENUM('latest', 'oldest');
  CREATE TYPE "public"."enum_pages_blocks_carousel_block_collection_type" AS ENUM('posts', 'skills', 'experience', 'portfolio');
  CREATE TYPE "public"."enum_pages_blocks_carousel_block_sort" AS ENUM('latest', 'oldest');
  CREATE TYPE "public"."enum_pages_blocks_section_block_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_blog_block_sort" AS ENUM('latest', 'oldest');
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_block_collection_type" AS ENUM('posts', 'skills', 'experience', 'portfolio');
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_block_sort" AS ENUM('latest', 'oldest');
  CREATE TYPE "public"."enum__pages_v_blocks_section_block_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  ...
  CREATE TABLE "pages_blocks_blog_block" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"number_of_posts" numeric DEFAULT 5,
  	"category_id" integer,
  	"sort" "enum_pages_blocks_blog_block_sort" DEFAULT 'latest',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_skills_cloud_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_carousel_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"collection_type" "enum_pages_blocks_carousel_block_collection_type",
  	"number_of_documents" numeric DEFAULT 5,
  	"custom_class_names" varchar,
  	"sort" "enum_pages_blocks_carousel_block_sort" DEFAULT 'latest',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_section_block_columns" (
  	...
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"size" "enum_pages_blocks_section_block_columns_size" DEFAULT 'oneThird',
  	"custom_class_names" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_blog_block" (
  	...
  	"number_of_posts" numeric DEFAULT 5,
  	"category_id" integer,
  	"sort" "enum__pages_v_blocks_blog_block_sort" DEFAULT 'latest',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_skills_cloud_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_carousel_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"collection_type" "enum__pages_v_blocks_carousel_block_collection_type",
  	"number_of_documents" numeric DEFAULT 5,
  	"custom_class_names" varchar,
  	"sort" "enum__pages_v_blocks_carousel_block_sort" DEFAULT 'latest',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_section_block_columns" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"size" "enum__pages_v_blocks_section_block_columns_size" DEFAULT 'oneThird',
  	"custom_class_names" varchar,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_experience_v" (
  	...
  	"version_title" varchar,
  	"version_image_id" integer,
  	"version_date_from" timestamp(3) with time zone,
  	"version_date_to" timestamp(3) with time zone,
  ...
  ALTER TABLE "pages_blocks_blog_block" ADD CONSTRAINT "pages_blocks_blog_block_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_skills_cloud_block" ADD CONSTRAINT "pages_blocks_skills_cloud_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_carousel_block" ADD CONSTRAINT "pages_blocks_carousel_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_blog_block" ADD CONSTRAINT "_pages_v_blocks_blog_block_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_skills_cloud_block" ADD CONSTRAINT "_pages_v_blocks_skills_cloud_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_carousel_block" ADD CONSTRAINT "_pages_v_blocks_carousel_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "skills" ADD CONSTRAINT "skills_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "skills" ADD CONSTRAINT "skills_categories_id_skills_categories_id_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."skills_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "portfolio_rels" ADD CONSTRAINT "portfolio_rels_skills_fk" FOREIGN KEY ("skills_id") REFERENCES "public"."skills"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_portfolio_v" ADD CONSTRAINT "_portfolio_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_portfolio_v_rels" ADD CONSTRAINT "_portfolio_v_rels_skills_fk" FOREIGN KEY ("skills_id") REFERENCES "public"."skills"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_experience_v" ADD CONSTRAINT "_experience_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_skills_categories_fk" FOREIGN KEY ("skills_categories_id") REFERENCES "public"."skills_categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_blog_block_category_idx" ON "pages_blocks_blog_block" USING btree ("category_id");
  CREATE INDEX "pages_blocks_skills_cloud_block_order_idx" ON "pages_blocks_skills_cloud_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_skills_cloud_block_parent_id_idx" ON "pages_blocks_skills_cloud_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_skills_cloud_block_path_idx" ON "pages_blocks_skills_cloud_block" USING btree ("_path");
  CREATE INDEX "pages_blocks_carousel_block_order_idx" ON "pages_blocks_carousel_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_carousel_block_parent_id_idx" ON "pages_blocks_carousel_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_carousel_block_path_idx" ON "pages_blocks_carousel_block" USING btree ("_path");
  CREATE INDEX "pages_blocks_section_block_columns_order_idx" ON "pages_blocks_section_block_columns" USING btree ("_order");
  CREATE INDEX "pages_blocks_section_block_columns_parent_id_idx" ON "pages_blocks_section_block_columns" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_blog_block_category_idx" ON "_pages_v_blocks_blog_block" USING btree ("category_id");
  CREATE INDEX "_pages_v_blocks_skills_cloud_block_order_idx" ON "_pages_v_blocks_skills_cloud_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_skills_cloud_block_parent_id_idx" ON "_pages_v_blocks_skills_cloud_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_skills_cloud_block_path_idx" ON "_pages_v_blocks_skills_cloud_block" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_carousel_block_order_idx" ON "_pages_v_blocks_carousel_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_carousel_block_parent_id_idx" ON "_pages_v_blocks_carousel_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_carousel_block_path_idx" ON "_pages_v_blocks_carousel_block" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_section_block_columns_order_idx" ON "_pages_v_blocks_section_block_columns" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_section_block_columns_parent_id_idx" ON "_pages_v_blocks_section_block_columns" USING btree ("_parent_id");
  ...
  CREATE INDEX "skills_image_idx" ON "skills" USING btree ("image_id");
  CREATE INDEX "skills_categories_idx" ON "skills" USING btree ("categories_id");
  ...
  CREATE UNIQUE INDEX "skills_categories_slug_idx" ON "skills_categories" USING btree ("slug");
  CREATE INDEX "skills_categories_updated_at_idx" ON "skills_categories" USING btree ("updated_at");
  CREATE INDEX "skills_categories_created_at_idx" ON "skills_categories" USING btree ("created_at");
  ...
  CREATE INDEX "portfolio_rels_skills_id_idx" ON "portfolio_rels" USING btree ("skills_id");
  CREATE INDEX "_portfolio_v_parent_idx" ON "_portfolio_v" USING btree ("parent_id");
  CREATE INDEX "_portfolio_v_version_version_image_idx" ON "_portfolio_v" USING btree ("version_image_id");
  ...
  CREATE INDEX "_portfolio_v_rels_skills_id_idx" ON "_portfolio_v_rels" USING btree ("skills_id");
  CREATE INDEX "experience_image_idx" ON "experience" USING btree ("image_id");
  ...
  CREATE INDEX "_experience_v_version_version_image_idx" ON "_experience_v" USING btree ("version_image_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_skills_categories_id_idx" ON "payload_locked_documents_rels" USING btree ("skills_categories_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_skills_cloud_block" CASCADE;
  DROP TABLE "pages_blocks_carousel_block" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_skills_cloud_block" CASCADE;
  DROP TABLE "_pages_v_blocks_carousel_block" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_blog_block_sort";
  DROP TYPE "public"."enum_pages_blocks_carousel_block_collection_type";
  DROP TYPE "public"."enum_pages_blocks_carousel_block_sort";
  DROP TYPE "public"."enum_pages_blocks_section_block_columns_size";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_blog_block_sort";
  DROP TYPE "public"."enum__pages_v_blocks_carousel_block_collection_type";
  DROP TYPE "public"."enum__pages_v_blocks_carousel_block_sort";
  DROP TYPE "public"."enum__pages_v_blocks_section_block_columns_size";
